 ...
 *
 * 		-	Some devices (Like STM32F1 & STM32F401) have multiplexed edge detection
 * 			units. Hence, be careful when initializing new lines, as they may
 * 			overwrite a previous initialization of another line.
 *
 * 		-	"ucEdge":
 * 			-	0==> Negative edge.
 * 			-	1==> Positive edge.
